from dml import (kNN, PCA, LDA, LLDA, ANMM, LMNN, NCA, NCMML, NCMC, ITML, DMLMJ, MCML,
                 LSI, DML_eig, LDML, GMML, KLMNN, KANMM, KDMLMJ, KDA, Euclidean, NCMC_Classifier)
