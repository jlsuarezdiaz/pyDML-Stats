...
#  $ python dim.py 2
#
#  $ python recopilate.py all
#
# (To recopilate only a part of the experiments run `$ python recopilate.py exp arg` , where 'exp' is the experiment (between basic, ker,
# ncm and dim), and 'arg' is the argument specified on the experiment, or 'all' (e.g.: `$ python recopilate.py basic small)).
